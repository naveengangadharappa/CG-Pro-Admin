                                        ...
                                        <Card.Body>
                                            <div className="align-items-center justify-content-center">
                                                ...
                                                <div className="col-auto">
                                                    <a href={`http://115.124.127.245:3002/Mission_Onboarding/get_file?fname=${this.state.employee_data.Emp_Avathar_id}`}><img style={{ width: '100%', height: '100%' }} src={`http://115.124.127.245:3002/Mission_Onboarding/get_file?fname=${this.state.employee_data.Emp_Avathar_id}`} alt='Avathar Image Not found' /></a>
                                                </div>
                                            </div>
